...
export function ProfilePanel(): React.JSX.Element {
  return (
    <div className="max-w-[820px] animate-[rmx-fade_.3s_ease]">
      <h1 className="text-2xl font-semibold tracking-tight text-ink">Profil Admin</h1>
      ...
      <div className="flex flex-col gap-[18px]">
        ...
        <section className={`${CARD} flex flex-wrap items-center gap-5`}>
          <span className="flex h-[76px] w-[76px] flex-none items-center justify-center rounded-full bg-gradient-to-br from-brand to-brand-dark text-[28px] font-semibold text-white">
            AD
          </span>
          ...
          <button
            ...
            className="h-[42px] rounded-btn border border-admin-border bg-white px-4 text-sm font-semibold hover:bg-gray-50"
          >
            Ganti Foto
          </button>
        </section>
        ...
        <section className={CARD}>
          <h3 className="mb-[18px] text-base font-semibold text-ink">Informasi Akun</h3>
        ...
        {/* Security */}
        <section className={CARD}>
          <h3 className="mb-1.5 text-base font-semibold text-ink">Keamanan</h3>
          <div className="flex flex-wrap items-center justify-between gap-3.5 py-3.5">
            <div>
              <div className="text-[14.5px] font-semibold text-ink">Ubah Password</div>
              <div className="text-[13px] text-gray-400">Terakhir diubah 3 bulan lalu</div>
            </div>
            <button
              type="button"
              onClick={() => toast.success("Formulir ubah password")}
              className="h-[38px] rounded-btn border border-admin-border bg-white px-3.5 text-[13.5px] font-semibold hover:bg-gray-50"
            >
              Ubah
            </button>
          </div>
