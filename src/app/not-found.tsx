  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto flex max-w-[720px] flex-1 flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <h1 className="mt-3.5 text-[26px] font-semibold text-ink">
          Halaman tidak ditemukan
        </h1>
        <p className="mx-auto mt-2.5 mb-7 max-w-[420px] text-[15.5px] leading-relaxed text-muted">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link
            href="/search"
            className="inline-flex h-[50px] items-center rounded-btn border border-gray-200 bg-white px-[22px] text-[15px] font-medium text-ink hover:border-border-strong"
          >
            Cari Produk
          </Link>
        </div>
